...
In the [Overview](accordproject) Section, we already saw how logic can be embedded in the text of the template itself to automaticallyref-ergo-spec.md calculate a monthly payment for a :
